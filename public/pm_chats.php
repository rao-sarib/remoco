...
// Fetch chats for Project Manager.
// Bound rather than interpolated: $user_id comes from the session and is an
// integer today, but building SQL by concatenation is the wrong habit and every
// other query in the project binds its parameters.
$stmt = $conn->prepare("SELECT * FROM chats WHERE pm_id = ?");
...
<body>
    <div class="container py-4">
        <div class="d-flex align-items-center mb-4">
            <a href="pm_dashboard.php" class="btn btn-outline-secondary me-2"><i class="fas fa-arrow-left"></i></a>
            <h1 class="mb-0"><i class="fas fa-comments me-2"></i>Project Manager Chats</h1>
        </div>
