...
if ($_SESSION['designation'] !== 'Team Member') {
...
// Fetch chats for Team Member. Bound rather than interpolated - see pm_chats.php.
$stmt = $conn->prepare("SELECT * FROM chats WHERE ? IN (tm1_id, tm2_id, tm3_id)");
...
<body>
    <div class="container py-4">
        <div class="d-flex align-items-center mb-4">
            <a href="tm_dashboard.php" class="btn btn-outline-secondary me-2"><i class="fas fa-arrow-left"></i></a>
            <h1 class="mb-0"><i class="fas fa-comments me-2"></i>Team Member Chats</h1>
        </div>
