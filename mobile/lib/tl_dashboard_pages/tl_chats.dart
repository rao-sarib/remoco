...
class TlChatsPage extends StatefulWidget {
  final int userId;
  final String userName;

  const TlChatsPage({super.key, required this.userId, required this.userName});

  @override
  State<TlChatsPage> createState() => _TlChatsPageState();
}

class _TlChatsPageState extends State<TlChatsPage> {
  ...
  Future<void> fetchChats() async {
    final url = Uri.parse(
        'http://$apiHost/remoco_app/api/get_tl_chats.php?tl_id=${widget.userId}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(currentChatTitle ?? 'Team Lead Chats'),
