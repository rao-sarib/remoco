...
import 'package:remoco_app/tm_dashboard_pages/tm_assigned_tasks.dart';
import 'package:remoco_app/tm_dashboard_pages/tm_chats.dart';
import 'package:remoco_app/tm_dashboard_pages/tm_home.dart';
...
class TmDashboard extends StatefulWidget {
  ...
  @override
  _TmDashboardState createState() => _TmDashboardState();
}
                      ...
                      Expanded(
                        child: ListView(
                          children: [
                            ...
                            sidebarItem(Icons.assignment_turned_in, "ASSIGNED TASKS", 'assigned_tasks'),
