...
import 'package:remoco_app/tl_dashboard_pages/tl_assigned_tasks.dart';
import 'package:remoco_app/tl_dashboard_pages/tl_chats.dart';
...
class _TlDashboardState extends State<TlDashboard> {
  ...
  Widget getPage() {
    switch (currentPage) {
      ...
      case 'assigned_tasks':
        return TlAssignedTasks(
          employeeId: widget.employeeId,
          companyId: widget.companyId, // <-- PASS THIS
        );
      case 'tasks':
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        // Top line: hamburger + logout button with employee name
                        Padding(
